...
public class RegisterUserTest {
  ...
  public void testRegisterUser() throws Exception {
    ...
    driver.get(baseUrl + "/MusicStore/Account/Register");
    ...
    //assertEquals("Account creation was unsuccessful. Please correct the errors and try again.", registerPage.errorMessage1.getText());
